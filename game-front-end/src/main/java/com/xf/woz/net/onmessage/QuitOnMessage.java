/**
 * @description : [quit命令的onmessage]
 * @author : [肖峰]
 * @version : [v1.0]
 * @createTime : [2022-12-24 16:08]
 * @updateUser : [肖峰]
 * @updateTime : [2022-12-24 16:08]
...
@Slf4j
public class QuitOnMessage implements UserOnMessage {
    @Override
    public int getCmdMerge() {
        return CmdKit.merge(CmdModule.USER_ACTION, UserCmd.QUIT);
    }
    ...
    public static QuitOnMessage me() {
        return Holder.ME;
    }
    ...
    private static class Holder {
        static final QuitOnMessage ME = new QuitOnMessage();
    }
}
